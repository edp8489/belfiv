...
C        DOO = BELLOWS OUTSIDE DIAMETER, IN.
...
C
   ...
   185 FORMAT(1X,'DO YOU WISH TO SAVE THE INPUT DATA ? (YES=1, NO=2)'/)
       ...
       WRITE(10,236)DI,DOO,E,RHOM,KA,LOVERD
...
C
   ...
   230 FORMAT(3I3)
       ...
       READ(7,236)DI,DOO,E,RHOM,KA,LOVERD
   235 FORMAT(6F10.3)
...
C
   ...
   805 FORMAT(1X,70A1)
       WRITE(DEV,840) SIGMA,LAMBDA,H,T,DI,DOO,NC,NPLY,E
